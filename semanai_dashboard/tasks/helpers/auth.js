...
module.exports = {
  init: function (options) {
    options = options || {}
    this.clientId = options.clientId || 'myclient';
    this.serverUrl = options.serverUrl || 'https://3f8c69de-2ccf-40e5-ac17-4bdd2e928fe0.predix-uaa.run.aws-usw02-pr.ice.predix.io';
    this.accessToken = null;
    this.defaultClientRoute = options.defaultClientRoute || '/about';
    this.base64ClientCredential = options.base64ClientCredential || 'bXljbGllbnQ6Y2xpZW50c2VjcmV0Cg==';
    this.user = null;
