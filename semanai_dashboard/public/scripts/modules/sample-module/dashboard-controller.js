define(['angular', './sample-module'], function (angular, controllers) {
    ...
    controllers.controller('DashboardsCtrl', ['$scope', '$log', 'PredixAssetService', 'PredixViewService', function ($scope, $log, PredixAssetService, PredixViewService) {
        ...
        $scope.openContext = function (contextDetails) {
            ...
            var url = {
                'parent': {
                    'datagrid-data': 'public/sample-data/datagrid-data.json'
                },
                'child': {
                    'core-vibe-rear-cruise': 'public/sample-data/core-vibe-rear-cruise.json',
                    'delta-egt-cruise': 'public/sample-data/delta-egt-cruise.json'
                },
                'child2': {
                    'core-vibe-rear-cruise': 'public/sample-data/core-vibe-rear-cruise0.json',
                    'delta-egt-cruise': 'public/sample-data/delta-egt-cruise.json'
                },
                'child3': {
                    'core-vibe-rear-cruise': 'public/sample-data/core-vibe-rear-cruise1.json',
                    'delta-egt-cruise': 'public/sample-data/delta-egt-cruise.json'
                }
            };
