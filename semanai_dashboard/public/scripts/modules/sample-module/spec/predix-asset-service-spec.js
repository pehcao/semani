        ...
        describe('with predix asset service', function() {
            ...
            describe('when getting asset root', function() {
                ...
                beforeEach(function() {
                    ...
                    $httpBackend.when('GET', '/public/sample-data/sample-asset-null.json').respond(topLevelData);
                ...
                it('will fetch context root with default url and rootEntityId null', function() {
                    $httpBackend.expectGET('/public/sample-data/sample-asset-null.json');
                    $httpBackend.flush();
                });
            ...
            describe('when response fails getting asset root', function() {
                ...
                beforeEach(function() {
                    ...
                    $httpBackend.when('GET', '/public/sample-data/sample-asset-null.json').respond(500);
                    PredixAssetService.getAssetsByParentId(null).then(successCallback, errorCallback);
                    $httpBackend.flush();
                });
            ...
            describe('when getting the children of an asset', function() {
                ...
                beforeEach(function() {
                    ...
                    $httpBackend.when('GET', '/public/sample-data/sample-asset-24.json').respond(secondLevelData);
                ...
                it('will fetch asset root with default url and rootEntityId 24', function() {
                    $httpBackend.expectGET('/public/sample-data/sample-asset-24.json');
                    $httpBackend.flush();
                });
            ...
            describe('when response fails getting the children of a node', function() {
                ...
                beforeEach(function() {
                    ...
                    $httpBackend.when('GET', '/public/sample-data/sample-asset-24.json').respond(500);
                    PredixAssetService.getAssetsByParentId(24).then(successCallback, errorCallback);
                    $httpBackend.flush();
                });
